...
- generated: `2026-07-18T09:47:29+0300`
- host: `Linux 6.12.61-6.12-alt1 x86_64`

## Sandbox suite (hermetic, no network)
```
Test files: 23   passed: 23   failed: 0 ALL GREEN 
```
...
generated: 2026-07-18T09:48:54+0300
host:      Linux 6.12.61-6.12-alt1 x86_64
opencode:  1.17.11
...
```
PASS: 29 FAIL: 0 SKIP-QUOTA: 5 SKIP-TRANSIENT: 1 SKIP-GATED: 2 TOTAL: 37
```
